  ...
  return (
    ...
    <div className='product-list'>
      ...
      <div className='table'>
        ...
        <button className='--btn --btn-primary button-create' onClick={goCreateStoreList}>Create Sub Store</button>
        <button className='--btn --btn-primary button-create' onClick={goCreateMainStore}>Create Main Store</button>
        </div>
        <span>
          <Search 
            type="text"
