  ...
  return (
    <div className='product-list'>
      ...
      <div className='table'>
        ...
        <button className='--btn --btn-primary button-create' onClick={goCreateProduct}>Create New Product</button>
        <button className='--btn --btn-primary button-create' onClick={goCreateProductCategory}>Create Product Category</button>
        <button className='--btn --btn-primary button-create' onClick={goToCategory}>Category List</button>
        </div>
